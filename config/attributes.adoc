...
//titre du document
:_document_title: UML - Le diagramme de classes
...
:_git_remote_for_current_adocument: https://gitlab.com/gemkod/uml.git
...
:_git_remotes_for_students: https://gitlab.com/gemkod/230213_umldata_apprentis.git
...
:_url_to_repo_for_students: https://gitlab.com/gemkod/230213_umldata_apprentis.git
