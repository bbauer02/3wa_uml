...
:_git_remote_for_current_adocument: https://github.com/bbauer02/3wa_uml.git
...
:_git_remotes_for_students: https://github.com/bbauer02/3wa_uml_etudiant.git
...
:_url_to_repo_for_students: https://github.com/bbauer02/3wa_uml_etudiant.git
