...
:_git_remotes_for_students: https://gitlab.com/gemkod/230403_fsd39b_uml_data.git
...
:_url_to_repo_for_students: https://gitlab.com/gemkod/230403_fsd39b_uml_data.git
