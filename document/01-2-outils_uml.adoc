...
Si le "preview" n'affiche rien, voir ce https://stackoverflow.com/questions/70039939/how-to-use-the-plantuml-preview-in-vscode[sujet]
...
:breakpoint_date: lun. 13/02 à 12:16
//on masque la correction à partir de ce point
:_show_correction: 0
#Point d'arrêt du cours au lun. 13/02 à 12:16#
