...
[source%linenums,php]
----
include::../assets/source_code/_implementation_asso_bi_simple.php[tags=!*;class_Technician;method_technician_constructor]
----
...
[source%linenums,php]
----
include::../assets/source_code/_implementation_asso_bi_simple.php[tags=!*;class_Vehicle;method_vehicle_constructor]
----
...
----
//classe Vehicle
include::../assets/source_code/_implementation_asso_bi_simple.php[tags=!*;method_set_technician;mutator_accessor_of_technician;]
----
...
:breakpoint_date: mar. 04/04 à 11:12
//on masque la correction à partir de ce point
:_show_correction: 0
#Point d'arrêt du cours au mar. 04/04 à 11:12#
