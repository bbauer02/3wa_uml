...
En PHP, https://www.php.net/manual/fr/class.exception.php[une exception] se lance de la façon suivante :

[source,php]
----
throw new Exception('ici un message');
----
...
[source%linenums,php]
----
include::../assets/source_code/implementation_waiter_one_to_four_table_uni.php[tags=!*;class_Waiter;method_add_table]
----
...
----
//A ajouter dans la classe Waiter
include::../assets/source_code/implementation_waiter_one_to_four_table_uni.php[tags=!*;method_add_table;check_limit_number_tables]
----
...
****
*Q{counter:_question})*
Implémentez le diagramme suivant et levez une exception lorsque la cardinalité n'est pas respectée :
...
****
*Q{counter:_question})*
Exercice supplémentaire (si le temps le permet).

Implémentez le diagramme suivant :

[plantuml,target=trois_classes_bidirectionnelle,format=svg]
....
hide circle
skinparam classAttributeIconSize 0
