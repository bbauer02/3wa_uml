...
(Order, Product) .. order_line
Product "1" -left> "*" Price
Supplier "1" <-- "*" Product
...
....
include::../assets/source_code/schema_relationnel.puml[tags=!*;]
....
// end _show_plantuml
endif::[]
...
:breakpoint_date: ven. 17/02 à 08:41
//on masque la correction à partir de ce point
:_show_correction: 0
#Point d'arrêt du cours au ven. 17/02 à 08:41#
