...
Il suffit de boucler sur la collection passée en argument et d'ajouter à la collection de technicien chacun des items parcourus (*en ayant préalablement vider la collection existante*)

[source%linenums,php]
----
include::../assets/source_code/_implementation_asso_uni_multiple.php[tags=!*;method_set_technicians;init_technicians_from_array;init_technicians_with_check_array]
----
...
Si ce n'est pas le cas, une erreur fatale sera générée.
...
[source%linenums,php]
----
include::../assets/shared_pending/Student2.php[tags=!*;]
----
****
//end _show_correction
endif::[]
