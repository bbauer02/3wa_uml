...
** Il existe une link:uml_le_diagramme_de_classes_v0.0.24_etu.pdf[version pdf sans la correction des exercices] (version idéale pour les apprentis)
** Il existe une link:uml_le_diagramme_de_classes_v0.0.24_correction.pdf[version pdf avec les corrections des exercices] (version idéale pour les formateurs)
