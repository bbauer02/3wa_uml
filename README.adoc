...
** Il existe une link:uml_le_diagramme_de_classes_v0.0.23_correction.pdf[version pdf avec les corrections des exercices] (version idéale pour les formateurs)
